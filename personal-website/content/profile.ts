...
export const profile = {
  ...
  advisoryEmail: "advisory@musaallama.com",
  whatsapp: "+2348025555520",
  bankTransfer: {
    accountName: "Geidam AGRO ALLIED NIGERIA LTD",
    accountNumber: "1001689506",
    bankName: "UBA BANK"
  },
  languages: ["English", "Arabic", "Mandarin Chinese", "Hausa", "Kanuri", "Code"],
  socialLinks: [
    {
      label: "LinkedIn",
      href: "https://www.linkedin.com/in/musa-garba-34594b7b"
    }
  ] as SocialLink[],
  ...
  pressTopics: [
    ...
    "Executive spiritual intelligence",
    "Philanthropy as human capital development"
  ],
  advisoryOffers: [
